...
@implementation YJStretchToolBar
                             ...
                             landscapePoint:(CGPoint)landscapePoint
{
    ...
    YJStretchToolBar *controlBar = [[YJStretchToolBar alloc] initWithFrame:newFrame];;
    ...
    controlBar.unfoldedPortraitF = [YJStretchToolBar adaptFrameForUnfoldedBarWithBarWidth:barW foldedFrame:foldedPortraitFrame isPortrait:YES isFirst:&isPortraitToggleFirst];
    controlBar.isPortraitToggleFirst = isPortraitToggleFirst;
    controlBar.unfoldedLandscapeF = [YJStretchToolBar adaptFrameForUnfoldedBarWithBarWidth:barW foldedFrame:foldedLandscapeFrame isPortrait:NO isFirst:&isLandscapeToggleFirst];
